...
/*
    d888888b  db .d888b. d8b   db
      `88'   o88 88   8D 888o  88
      88     88 `VoooY' 88V8o 88
      88     88 .d~~~b. 88 V8o88
      .88.    88 88   8D 88  V888
    Y888888P  VP `Y888P' VP   V8P   Translate anything.
*/
...
const fromByLanguage = (byLanguage: NameField_ByLanguage, options: i18nOptions): string => {
  ...
  if(typeof byLanguage[i18nSettings.getCurrentLanguage()] !== "undefined") { // Default language
    options.language = i18nSettings.getCurrentLanguage()
    return i18n(byLanguage[options.language] as i18nSchema, options)
  }
  return ""
}
