...
var Logger = (function () {
    ...
    Logger.prototype.log = function (context, force, color, title) {
        var data = [];
    ...
    Logger.prototype.logSuccess = function (context, title) {
        ...
        this.log.apply(this, [context, false, "#a4f6a5", title].concat(data));
    };
    Logger.prototype.logError = function (context, title) {
        ...
        this.log.apply(this, [context, true, "#f68787", title].concat(data));
    };
    Logger.prototype.logInfo = function (context, title) {
        ...
        this.log.apply(this, [context, false, "#f1eb9a", title].concat(data));
    };
    Logger.prototype.logView = function (context, title) {
        ...
        this.log.apply(this, [context, false, "#f8a978", title].concat(data));
    };
    return Logger;
}());
