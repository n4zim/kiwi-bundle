        ...
        if (this.isCompatible) {
            ...
            if ("caches" in window) {
                navigator.serviceWorker.oncontrollerchange = function () {
                    logger_1.logger.logSuccess("ServiceWorker", "Changed controller");
        ...
        if (this.isCompatible) {
            navigator.serviceWorker.register("/" + window.kiwi.sw, {
                ...
                navigator.serviceWorker.ready.then(function () {
                    logger_1.logger.logSuccess("ServiceWorker", "Loaded");
                });
            });
        }
    };
...
exports.serviceWorkerClient = new ServiceWorkerClient();
