...
var generateKiwiJson = function () { return ({
...
var generateStatsCheck = function (exitOnError) {
    if (exitOnError === void 0) { exitOnError = false; }
    return function (compiler) {
        compiler.hooks.done.tap("KiwiBundleStatsCheck", function (stats) {
