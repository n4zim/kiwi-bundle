...
exports.default = (function (path, outputPath, kiwiConfig, mode) {
    ...
    var config = {
        ...
        resolve: {
            ...
            modules: [
                path_1.default.join(bundlePath, "node_modules"),
            ],
            alias: {
        ...
        entry: {
            main: [path_1.default.join(path, "src", "client", "index.ts")],
        ...
        plugins: config_plugins_1.default(path, bundlePath, kiwiConfig).generate(mode),
